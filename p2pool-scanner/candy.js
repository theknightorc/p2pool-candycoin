...
function Scanner(options) {
    ...
    self.render = function() {
        ...
        _.each(list, function(info) {
            ...
            if (ip != '0.0.0.0') {
                ...
                str += "<div class='p2p-row "+(row++ & 1 ? "row-grey" : "")+"'><div class='p2p-ip'><a href='http://"+ip+":6151/static/' target='_blank'>"+ip+":6151</a></div><div class='p2p-fee'>"+fee+"%</div><div class='p2p-uptime'>"+uptime+" days</div>";
    ...
    self.inject = function(addr_list) {
        _.each(addr_list, function(info) {
            ...
            var port = info[0][1];
		// Block 127.0.0.1
            if(!self.addr_digested[ip] && !self.addr_pending[ip] && self.addr_pending[ip] != "127.0.0.1") {
